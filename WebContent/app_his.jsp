...
@media screen and (max-width: 780px){
  ...
  <body>
    ...
    <header>
      ...
      <div class="left_area">
        <h3><span>Patient|Appointment His</span></h3>
      </div>
    ...
    <div class="content">
		<%
			...
			String sql ="SELECT * FROM book_app where p_email=?";
			...
			row="<td>"+resultSet.getString(1)+"</td><td>"+resultSet.getString(2)+"</td><td>"+resultSet.getString(3)+"</td><td>"+resultSet.getString(4)+"</td><td>"+resultSet.getString(5)+"</td>";
